package com.wei.ggkt.order.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.wei.ggkt.client.activity.CouponInfoFeignClient;
...
import com.wei.ggkt.model.activity.CouponInfo;
import com.wei.ggkt.model.order.OrderDetail;
import com.wei.ggkt.model.order.OrderInfo;
import com.wei.ggkt.model.user.UserInfo;
import com.wei.ggkt.model.vod.Course;
import com.wei.ggkt.order.mapper.OrderInfoMapper;
import com.wei.ggkt.order.service.OrderDetailService;
import com.wei.ggkt.order.service.OrderInfoService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.wei.ggkt.utils.AuthContextHolder;
import com.wei.ggkt.utils.OrderNoUtils;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    @Override
    public boolean getOrderStatusById(Long courseId, Long userId) {
        OrderInfo orderInfo = baseMapper.getOrderStatus(courseId, userId);
        if (orderInfo == null) {
            return false;
        } else {
            return true;
