package com.wei.ggkt.wechat.service.impl;

import com.wei.ggkt.client.course.CourseFeignClient;
import com.wei.ggkt.model.vod.Course;
import com.wei.ggkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long id) {
        //微信openid
        String openid = "odowX6r9l8rzuesiBZz5RSfvTCdo";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("JePGdToBIn1wNG-pJTIoLPPmgiG2dbcOiMB-mWTcf1Q")//模板id
                .url("http://gqw1.5gzvip.91tunnel.com/#/pay/" + id)//点击模板消息要访问的网址
                .build();
    ...
    private String unsubscribe(Map<String, String> param) {
        return this.text(param, "感谢你关注过“硅谷课堂”，期待与您的下一次见面").toString();
    }
    ...
    private String search(Map<String, String> param) {
        ...
        if (CollectionUtils.isEmpty(courseList)) {
            ...
            articles.append("<Url><![CDATA[http://glkt.wei.cn/#/liveInfo/" + course.getId() + "]]></Url>");
            articles.append("</item>");
